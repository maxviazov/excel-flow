...
# ACM Certificate for api.viazov.dev
resource "aws_acm_certificate" "api" {
  domain_name       = "api.viazov.dev"
...
# ALB Listener HTTPS (without certificate for now)
...
# ACM Certificate for excel.viazov.dev (us-east-1 for CloudFront)
provider "aws" {
  alias  = "us_east_1"
  region = "us-east-1"
}
...
output "api_url" {
  value = "https://api.viazov.dev"
}

output "frontend_url" {
  value = "https://excel.viazov.dev"
}
